...
<div class="mdui-card mdui-hoverable" style="border-radius: 16px">
    <div class="mdui-card-media">
        <img style="max-height: 1000px" src="/static/uploads/compressed.png" />
    </div>
    ...
    <div class="mdui-card-content">
        <div class="mdui-typo">
            ...
            程序版本:V1.5.9<br />
            开源项目的原作者博客:<a href="https://www.wunote.cn" class="text-decoration: none;">吴先森的笔记</a>，作者邮箱:i@mr-wu.top<br>
            如果有任何建议或者此站点侵犯了您的权益，请及时联系站长邮箱<strong>abnermod@163.com</strong><br>
        </div>
    </div>
</div>
<br /><br />