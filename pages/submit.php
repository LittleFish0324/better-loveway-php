...
<div class="mdui-card mdui-hoverable" style="border-radius: 16px">
    ...
    <div class="mdui-card-content">
        <div class="mdui-textfield">
            ...
            <textarea id="qq" class="mdui-textfield-input" placeholder="12345678（可选填）"></textarea>
        </div>
        <div class="mdui-textfield">
        ...
        <div class="mdui-textfield">
            ...
            <textarea id="name" class="mdui-textfield-input" placeholder="例如：邓中国"></textarea>
        </div>
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">TA的名字</label>
            <textarea id="taName" class="mdui-textfield-input" placeholder="例如：邓中国"></textarea>
        </div>
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">表白配图（可选，输入框可以填在线图片的URL链接，如果你不了解这个的话就不用管这个）</label>
            <?php
            if ($UPLOAD_IMAGE) {
            ?>
                <div class="mdui-row">
